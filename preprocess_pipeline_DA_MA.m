...
cfg.trials = [1:2]; % it is best to perform the analysis on trials with artifacts
...
%% Save the data
save('C:\Users\Roey\Documents\Lab\PNES Project\LongSegments\post ICA\pDA_MA_post_ICA.mat', 'postIcaData')
