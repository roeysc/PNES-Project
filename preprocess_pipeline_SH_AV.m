...
rawData = mat2rawdata(cfg, 'C:\Users\Roey\Documents\Lab\PNES Project\LongSegments\pSH_AV.mat');
...
rereferencedData.trialsStartTime = interpolatedData.trialsStartTime; 
...
cfg.trials = [4 5 8 20 21 22]; % it is best to perform the analysis on trials with artifacts
...
cfg = [];
cfg.component = [1 6]; % components to be removed
...
%% Save the data
save('C:\Users\Roey\Documents\Lab\PNES Project\LongSegments\post ICA\pSH_AV_post_ICA.mat', 'postIcaData')
...
load('C:\Users\Roey\Documents\Lab\PNES Project\LongSegments\post ICA\pSH_AV_post_ICA.mat')
