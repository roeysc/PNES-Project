...
rawData = mat2rawdata(cfg, 'C:\Users\Roey\Documents\Lab\PNES Project\LongSegments\pYA_ME.mat');
...
cfg.trials = [7 8 9 19 21 22 23 24]; % it is best to perform the analysis on trials with artifacts
...
cfg = [];
cfg.component = [1 2 11]; % components to be removed
...
%% Save the data
save('C:\Users\Roey\Documents\Lab\PNES Project\LongSegments\post ICA\pYA_ME_post_ICA.mat', 'postIcaData')
...
load('C:\Users\Roey\Documents\Lab\PNES Project\LongSegments\post ICA\pYA_ME_post_ICA.mat')
