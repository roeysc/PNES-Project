function [Z, T] = clusterdata_return_z(X, varargin)
%CLUSTERDATA_RETURN_Z Construct clusters from data.
% 
% Unlike clusterdata, it also returns the Z matrix (to be plotted with
% dendrogram)
% 
