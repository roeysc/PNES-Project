function [ sourceCondition1 ] = sourceAnalysisWrapConditionFilterOne( cfg, segmentedMRI, queryFile1 )
...
%
% NOTE: THIS VERSION OF SOURCEANALYSISWARP USES A FILTER FOR EACH CONDITION SEPERATLY
...
segmentedMRI = data.segmentedmri; % in  mm
...
cfg.keepfilter  = 'yes';
% % %  fix line 260 in ft_sourceanalysis

sourceCondition1 = ft_sourceanalysis(cfg, freqCondition1); 


% % % % Project each trial throught its Spatial Filter calculated above
cfg=[];
cfg.method  = 'dics';
cfg.elec = elec;
cfg.grid = grid;
...
% % %  sourceCondition2.avg.pow = avgPowCondition2; % THIS COULD BE
% PROBLEMATIC SINCE OTHER PARAMETERS ARE INVOLVED IN sourceCondition2